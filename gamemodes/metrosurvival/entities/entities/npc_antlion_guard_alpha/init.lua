...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "npc_antlion_guard_alpha" )
...
function ENT:Initialize()
	...
	self.npc:SetKeyValue( "allowbark", "1" )
	...
	self.npc:Spawn()
	self.npc:Activate()
	self.npc:SetHealth(600)
	self.npc:SetModelScale(1.1)
	self.npc:SetName("Antlion Guard Alpha")
